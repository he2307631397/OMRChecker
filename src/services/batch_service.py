...
def _normalize_runtime_config(config: dict) -> dict:
    ...
    section_maps = {
        ...
        "weak_mark_params": {
            ...
            "conflictUseDensity": "conflict_use_density",
            "conflictMinDensityGap": "conflict_min_density_gap",
            "conflictMinCenterDensity": "conflict_min_center_density",
            "detectTrueMultiConflicts": "detect_true_multi_conflicts",
            "trueMultiMinCenterDensity": "true_multi_min_center_density",
            "trueMultiMaxTopDensityGap": "true_multi_max_top_density_gap",
        ...
        "weak_multi_mark_params": {
            ...
            "maxMean": "max_mean",
            "maxMarks": "max_marks",
            "filterUseDensity": "filter_use_density",
            "filterMinCenterDensity": "filter_min_center_density",
            "filterMinDensityGap": "filter_min_density_gap",
            "fullSelectMinCenterDensity": "full_select_min_center_density",
            "fullSelectMaxDensitySpread": "full_select_max_density_spread",
